...
const categories = [
  {
    ...
    materials: [
      {
        name: 'Grey Stone',
        image: '/images/Polished concrete tile with swirling veins.png',
        gallery: [
          '/images/gallery/grey-marble-1.jpeg',
          '/images/gallery/grey-marble-2.jpeg',
          '/images/gallery/grey-marble-3.jpeg',
        ],
      },
      {
        name: 'Black Stone',
        image: '/images/Polished black marble with striking veins.png',
        gallery: [
          '/images/gallery/black-marble-1.jpeg',
          '/images/gallery/black-marble-2.jpeg',
          '/images/gallery/black-marble-3.jpeg',
        ],
      },
      {
        name: 'Grey Ghost',
        image: '/images/grey-ghost.png',
        gallery: [
          '/images/gallery/grey-ghost-1.jpeg',
        ],
      },
    ],
  },
    ...
    materials: [
      {
        ...
        image: '/images/Polished concrete tile with swirling veins (1).png',
        gallery: [
          '/images/gallery/traditional-dark-matte-1.jpeg',
          '/images/gallery/traditional-dark-matte-2.jpg',
          '/images/gallery/traditional-dark-satin-1.jpeg',
        ],
      },
      {
        name: 'Traditional Medium',
        image: '/images/Polished concrete tile with organic veining.png',
        gallery: [
          '/images/gallery/traditional-medium-1.jpg',
          '/images/gallery/traditional-medium-2.jpeg',
          '/images/gallery/traditional-medium-3.jpeg',
          '/images/gallery/traditional-medium-gloss-1.jpg',
        ],
      },
      {
        name: 'Traditional Lite',
        image: '/images/traditional-lite.png',
        gallery: [
          '/images/gallery/traditional-lite-matte-1.jpeg',
          '/images/gallery/traditional-lite-matte-2.jpeg',
          '/images/gallery/traditional-lite-satin-1.jpg',
          '/images/gallery/traditional-lite-satin-2.jpg',
          '/images/gallery/traditional-lite-satin-3.jpg',
          '/images/gallery/traditional-lite-gloss-1.jpg',
        ],
      },
    ],
  },
    ...
    materials: [
      {
        ...
        image: '/images/Elegant gray-veined marble tile close-up.png',
        gallery: [
          '/images/gallery/smoke-1.jpeg',
          '/images/gallery/smoke-2.jpeg',
          '/images/gallery/smoke-3.jpeg',
          '/images/gallery/smoke-4.jpeg',
          '/images/gallery/smoke-gloss-1.jpg',
          '/images/gallery/smoke-gloss-2.jpg',
        ],
      },
      {
        name: '50 Shades of Grey',
        image: '/images/shades-of-grey.png',
        gallery: [
          '/images/gallery/50-shades-1.jpeg',
        ],
      },
      {
        name: 'Storm',
        ...
        gallery: [
          '/images/gallery/storm-matte-1.jpg',
          '/images/gallery/storm-gloss-1.jpg',
        ],
      },
      {
        name: 'Glacier',
        ...
        gallery: [
          '/images/gallery/glacier-satin-1.jpg',
        ],
      },
      {
        name: 'Forest',
        ...
        gallery: [
          '/images/gallery/forest-satin-1.jpeg',
          '/images/gallery/forest-satin-2.jpeg',
          '/images/IMG_2154.jpeg',
          '/images/IMG_2156.jpeg',
          '/images/IMG_2155.jpeg',
        ],
      },
      {
        name: 'Sand Dune',
        variants: ['Satin', 'Gloss', 'Grey'],
        image: '/images/sand-dune.png',
        gallery: [
          '/images/gallery/sand-dune-satin-1.jpeg',
          '/images/gallery/sand-dune-gloss-1.jpg',
          '/images/gallery/sand-dune-grey-1.jpeg',
        ],
      },
    ],
  },
